...
var trung ={}
trung = JSON.parse(JSON.stringify(doan));
trung.name = "Trung";
trung.clone = true ;
console.log(doan);
console.log(trung);
...
console.log(greeting.substring(greeting.indexOf('Academy'),greeting.length));
console.log(greeting.split(' ',2));
